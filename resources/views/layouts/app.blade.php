...
<head>
    ...
    <link src="https://code.jquery.com/jquery-3.6.1.min.js"
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    @else
                        ...
                        <li class="nav-item dropdown">
                            <a id="navbarDropdown" class="nav-link dropdown-toggle" href="#" role="button"
                               data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                                {{ trans("website.general.online_users") }} <span class="caret"></span>
                            </a>

                            <div id="online" class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                            </div>
